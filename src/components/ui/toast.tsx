...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-4 left-1/2 -translate-x-1/2 sm:bottom-4 sm:right-4 sm:top-auto sm:left-auto sm:translate-x-0 z-[200] flex max-h-screen w-[90vw] max-w-sm flex-col-reverse p-4 sm:w-full",
      className
    )}
    {...props}
  />
