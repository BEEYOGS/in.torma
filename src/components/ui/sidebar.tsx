...
>(
  (
    ...
    const { isMobile, state, openMobile, setOpenMobile, side, open, setOpen } = useSidebar()
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="header"
      className={cn("flex items-center border-b p-3 group-data-[collapsible=icon]:justify-center", className)}
      {...props}
    />
  )
})
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ...
      {...props}
    >
      <Button variant="ghost" className="justify-center" size="icon" onClick={toggleSidebar}>
        { state === 'collapsed' ? <ChevronsLeft /> : <ChevronsLeft className="transform rotate-180"/> }
      </Button>
    </div>
  )
})
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-0 overflow-auto p-2 group-data-[collapsible=icon]:items-center group-data-[collapsible=icon]:py-2",
        className
      )}
      {...props}
    />
