...
export function TaskAnalytics({ tasks }: TaskAnalyticsProps) {
    ...
    const kpiCards = [
        ...
        { title: "Tugas Aktif", value: analyticsData.activeTasks, icon: <Sun className="h-8 w-8 text-orange-400" /> },
    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            <DialogTrigger asChild>
                <SidebarMenuButton className="w-full justify-start" tooltip="Dasbor Analitik">
                    <AreaChart/>
                    <span className="group-data-[collapsible=icon]:hidden">Dasbor</span>
                </SidebarMenuButton>
            </DialogTrigger>
